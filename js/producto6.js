...
alert("ATENCION!! Estas a punto de comprar el siguiente vehiculo: " + vehiculo6 + " ( $" + vehiculo6precioconiva + " )")
...
aceptardatos.addEventListener("click", () => {
    ...
    info.innerHTML =
        ...
        `<h3> Felicidades ` + inombre.value + ` usted adquirio ` + incantidad.value + ` vehiculo/s `+ vehiculo6 + `. </h3>
<p> El precio final seria de  $`+ (incantidad.value * vehiculo6precioconiva) + `.  Proximamente le estaremos enviando el comprobante de compra a este mail: ` + inmail.value
